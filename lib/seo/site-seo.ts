...
const publicPageSeo = [
  {
    path: "/",
    primaryKeyword: "finished fabric supplier",
    secondaryKeywords: [
      "finished knit fabric supplier",
    ...
    metaTitle: "Finished Fabric Supplier for Apparel Brands | O'range Textile",
    metaDescription:
      "Finished fabric supplier for apparel brands sourcing premium finished knit and woven fabrics from Shaoxing Keqiao. Review supplied catalogue evidence, start from a sample, image or garment brief, and confirm composition, GSM, width, finish, quantity and testing before requesting an RFQ.",
    h1: "Finished Fabric Supplier for Premium Global Apparel Sourcing",
  ...
  },
  {
    ...
    secondaryKeywords: [
      "bulk finished knit fabric",
      "wholesale knit fabric",
      "bulk knit fabric sourcing",
  ...
  },
  {
    ...
    secondaryKeywords: [
      ...
      "interlock fabric vs single jersey",
  ...
  {
    path: "/blog/french-terry-fabric-vs-fleece",
    primaryKeyword: "french terry fabric vs fleece",
    secondaryKeywords: [
      "French terry vs fleece",
      "hoodie fabric comparison",
      "loop-back vs brushed fleece",
      "sweatshirt fabric sourcing",
    ],
    searchIntent: "informational",
    topicCluster: "buyer-comparison-terry",
    targetPageType: "blog",
    metaTitle:
      "French Terry Fabric vs Fleece: Buyer Guide | O'range Textile",
    metaDescription:
  ...
  {
    path: "/blog/french-terry-fabric-for-hoodies",
    primaryKeyword: "french terry fabric for hoodies",
    secondaryKeywords: [
      "French terry hoodie fabric",
      "hoodie fabric GSM",
      "loop-back sweatshirt fabric",
      "hoodie fabric supplier",
    ],
    searchIntent: "informational",
    topicCluster: "buyer-selection-terry",
    targetPageType: "blog",
    metaTitle:
      "French Terry Fabric for Hoodies: Buyer Guide | O'range Textile",
    metaDescription:
  ...
  {
    path: "/blog/heavyweight-french-terry-fabric",
    primaryKeyword: "heavyweight french terry fabric",
    secondaryKeywords: [
      "heavy French terry fabric",
      "heavyweight hoodie fabric",
      "French terry GSM guide",
      "winter sweatshirt fabric",
    ],
    searchIntent: "informational",
    topicCluster: "buyer-specification-terry",
    targetPageType: "blog",
    metaTitle:
      "Heavyweight French Terry Fabric Guide | O'range Textile",
    metaDescription:
  ...
  {
    path: "/blog/interlock-vs-jersey-fabric",
    primaryKeyword: "interlock vs jersey fabric",
    secondaryKeywords: [
      "interlock vs single jersey",
      "jersey fabric comparison",
      "double knit vs single knit",
      "T-shirt fabric selection",
    ],
    searchIntent: "informational",
    topicCluster: "buyer-comparison-jersey",
    targetPageType: "blog",
    metaTitle:
      "Interlock vs Jersey Fabric: Buyer Guide | O'range Textile",
    metaDescription:
      "Interlock vs jersey fabric compares a stable double-knit construction with a lighter single-knit direction. Review face and reverse, edge curl, opacity, drape, stretch, recovery, GSM, shrinkage and garment use before selecting a finished sample.",
    h1: "Interlock vs Jersey Fabric for Apparel Sourcing",
